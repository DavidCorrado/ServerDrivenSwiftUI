    ...
    return ServerCard(subviews: [
        ServerColumn(modifier: ServerModifier(spacingStart: 20, spacingEnd: 20, spacingTop: 24, spacingBottom: 24), subviews: [
            ServerRow(alignment: .CENTER, subviews: [
                ServerImage(url: "BP", modifier: ServerModifier(spacingEnd: 7, width: 18, height: 18)), ServerText(text: "Blood Pressure", size: 14, weight: "500"),
                ServerSpacer(),
            ...
            ServerRow(alignment: .CENTER, subviews: [
                ServerImage(url: "Running", modifier: ServerModifier(spacingEnd: 8, width: 20, height: 20)),
                generateBubble(),
                ServerText(text: "Per AHA guidelines", size: 12, weight: "500", modifier: ServerModifier(spacingStart: 8))
            ])
        ])
    ]
    )
