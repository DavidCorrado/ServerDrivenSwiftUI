...
struct History_Previews: PreviewProvider {
    static var previews: some View {
        SDContent(items: [ServerColumn(items: [history1(), history2()])], parentWeightDirection: .none, parentSize: .zero, nestedInVerticalLayout: false, nestedInHorizontalLayout: false)
    }
}

func history1() -> ServerColumn {
    return ServerColumn(modifier: ServerModifier(spacingStart: 20, spacingEnd: 20, spacingTop: 16, spacingBottom: 16), items: [
        ServerRow(alignment: .CENTER, items: [
            ServerColumn(items: [
                ...
                ServerRow(modifier: ServerModifier(spacingTop: 4), alignment: .CENTER, items: [
